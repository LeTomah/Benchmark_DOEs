def create_network():
    ...
    # Lignes
    pp.create_line(
        net, b0, b1, length_km=12, std_type="149-AL1/24-ST1A 110.0", name="line1"
    )
    pp.create_line(
        net, b1, b2, length_km=10, std_type="149-AL1/24-ST1A 110.0", name="line2"
    )
    pp.create_line(
        net, b0, b2, length_km=10, std_type="149-AL1/24-ST1A 110.0", name="line3"
    )
    pp.create_line(
        net,
        b3,
    ...
    pp.create_line(
        net, b5, b9, length_km=3, std_type="94-AL1/15-ST1A 0.4", name="line6"
    )
    pp.create_line(
        net, b6, b10, length_km=0.45, std_type="94-AL1/15-ST1A 0.4", name="line7"
    )
    pp.create_line(
        net, b0, b11, length_km=16, std_type="149-AL1/24-ST1A 110.0", name="line8"
    )
    pp.create_line(
        net, b11, b1, length_km=24, std_type="149-AL1/24-ST1A 110.0", name="line9"
    )
    pp.create_line(
        net, b0, b12, length_km=22, std_type="149-AL1/24-ST1A 110.0", name="line10"
    )
    pp.create_line(
        net, b12, b2, length_km=16, std_type="149-AL1/24-ST1A 110.0", name="line11"
    )
    ...
    pp.create_gen(
        net, bus=b7, p_mw=6.5, vm_pu=1.0, name="Wind Turbine", controllable=False
    )
